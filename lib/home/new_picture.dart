...
class NewPicture extends StatefulWidget {
  final bool bandera2;
  NewPicture({Key key, this.bandera2}) : super(key: key);
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        widget.bandera2 ? BlocProvider.of<ApplicationBloc>(context)
                            .add(BarcodeDetectorEvent()) : BlocProvider.of<ApplicationBloc>(context)
